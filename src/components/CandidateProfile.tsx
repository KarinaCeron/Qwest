            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={generateSummary}>
                  <Sparkles className="mr-1 h-4 w-4" /> Generate from my Qwest
                </Button>
              </div>
              <Textarea
                rows={6}
                ...
                placeholder="Summarize who you are as a candidate: the roles you're aiming for, your compensation expectations, and the benefits that matter to you. Or click 'Generate from my Qwest' to build it automatically."
                maxLength={2000}
              />
              <p className="text-xs text-muted-foreground">
                This summary saves automatically and represents your whole Qwest profile at a glance.
              </p>
            </div>
          </>
        )}
